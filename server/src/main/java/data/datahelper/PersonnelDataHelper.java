...
public interface PersonnelDataHelper {
	 ...
	 * 
	 * @param usertype
	 *            UserType型 userName String型 userID int型
	 * @return ArrayList<PersonListPO> 用来获取酒店工作人员列表信息
	 * @throws 未定
	 *             usertype限定当前搜索的是哪种人，可根据用户编号查询，也可根据用户名查询。当根据用户名查询时，
	 *             只要用户名中包含有传递进来的userName的关键词，就进行返回 如果编号和名字都为null，就返回该种人的全部列表信息
	 * 
	 */
	 ...
	 * 设置酒店工作人员信息
	 * 
	 * @param hotelWorkerDetailPO
	 *            HotelWorkerDetailPO型 用来传递酒店工作人员信息
