...
public class Hotelworkeradd_JPanel extends JPanel{
	...
	public Hotelworkeradd_JPanel(String id){
		this.id=id;
    ...
    */
    public void addComp(){
    	...
    	hotelnamejl.setBounds(300,250,100,50);
    	this.add(hotelnamejl);
    	hotelnamejtx.setBounds(350,250,200,50);
    	this.add(hotelnamejtx);
    	
    	teljl.setFont(font);
    	teljl.setBounds(300,320,100,50);
    	this.add(teljl);
    	teljtx.setBounds(350,320,200,50);
    	this.add(teljtx);
    	
    	passwordjl.setFont(font);
    	passwordjl.setBounds(300,390,100,50);
    	this.add(passwordjl);
    	passwordjtx.setBounds(350,390,200,50);
    	this.add(passwordjtx);
    	
        canclejb.setText("取消");
        canclejb.setBounds(300,460,100,30);
        this.add(canclejb);
        
        confirmjb.setText("确定");
        confirmjb.setBounds(450,460,100,30);
        this.add(confirmjb);
