...
public class HotelWorker implements Person {
	...
	/*
	 * public HotelWorker(ImageIcon userImage,String name,Telephone
	 * telephone,Password password,String id,String hotelName){
	 * this.userImage=userImage; this.name=name; this.telephone=telephone;
	 * this.password=password; this.id=id; this.hotelName=hotelName;
	 * 
	 * 
	 * }
	 */
