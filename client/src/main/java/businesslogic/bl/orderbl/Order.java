...
public class Order {
	...
	/**
	 * 检查输入的入住日期的格式 @param time Date型，传递入住日期 @return
	 * ResultMessage，格式正确返回SUCCESS,格式错误返回daoFORMATERROR, @throws
	 *
	 */
	 ...
	 * 
	 * @param vo
	 *            AvailableRoomNumberVO型，传递可用客房数量信息
